...
public class Main {
    ...
    static final File CAPERS_FOLDER = new File("capDIR");
    ...
    public static void setupPersistence() {
        CAPERS_FOLDER.mkdir();
        _dogsFile = Utils.join(CAPERS_FOLDER, "dogDIR");
        _dogsFile.mkdir();
        _storyFile = Utils.join(CAPERS_FOLDER, "story.txt");
    }
    ...
    public static void writeStory(String[] args) {
        ...
        String readloaded = null;
        if (_storyFile.exists()) {
            readloaded = Utils.readObject(_storyFile, String.class);
            String concate = readloaded + '\n' + args[1];
            Utils.writeObject(_storyFile, concate);
            System.out.println(concate);
        } else {
            String concate = args[1];
            Utils.writeObject(_storyFile, concate);
            System.out.println(concate);
        }
    }
    ...
    public static void makeDog(String[] args) {
        ...
        Dog dogcoming = new Dog(args[1], args[2], Integer.parseInt(args[3]));
        dogcoming.saveDog();
        System.out.println(dogcoming.toString());
    }
    ...
    /** File where stores dogs' info. */
    public static File _dogsFile;
    /** File where stores the story. */
    private static File _storyFile;
}
