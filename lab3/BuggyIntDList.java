...
//        if (d1._next == null) {
//            d1._next = d2;
//            d2 = sortedMerge(d2, d2._next);
////            d2._prev = null;
//            return d2;
//        }
//        if (d2._next == null) {
//            d2._next = d1;
//            d1 = sortedMerge(d1, d1._next);
//            return d1;
//        }
        // ------------------------------------------------------------------

        if (d1._val <= d2._val) {
            d1 = sortedMerge(d1._next, d2);   // FIXME: Replace this line (if needed). HINT: Step Into(F7) using debugger and try to figure out what it does.
            d1._next._prev = d1;
            d1._prev = null;
            return d1;
        } else {
