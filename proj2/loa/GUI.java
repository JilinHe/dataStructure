...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Setting->Undo", this::undo);
        addMenuButton("Setting->AUTO BLACK", this::autob);
        addMenuButton("Setting->AUTO WHITE", this::autow);
        addMenuButton("Setting->MANUAL BLACK", this::manualb);
        addMenuButton("Setting->MANUAL WHITE", this::manualw);
